...
\affil[1]{Univ. of Ja\'{e}n, Dept of Computer Sciences,\\
...
hypothesis is "there does not exist significant differences with respect to the
...
\section*{Acknowledgements}
 ...
 and
 PRY142/14 (que ha sido financiado íntegramente por la Fundaci\'{o}n P\'{u}blica Andaluza Centro de Estudios Andaluces en la IX Convocatoria de Proyectos de Investigaci\'{o}n)\footnote{The description in Spanish is mandatory.}.
 % Quizás Victor quiera meter su contrato de jaén-- Maribel
...
\end{center}
\end{table}
% Then, the majority of the users are running the faulty algorithm? - JJ
