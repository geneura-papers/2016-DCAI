...
We have already published the preliminary results obtained by the
initial proof of concept in \cite{DBLP:conf/dcai/RivasPMAG16}. In that
paper we fix errors found in the initial implementation and describe
further experiments that measure the 
...
In order to have into account the number of valid executions, a deeper analysis has been carried out, and 
