...
\section*{Acknowledgements}
 ...
 % Quiz�s Victor quiera meter su contrato de ja�n-- Maribel
...
\end{center}
\end{table}
\footnotetext{Chromium is the open-source project behind Chrome}
...
\end{center}
\end{table}
\footnotetext{The number of executions should have been $10$ for
  all browsers. It is different for Chromium and Chrome browsers,
