...
algorithm is run in the same version of each browser.
The presented
...
\FOR{generation = 1 \TO n}
   ...
   \STATE{Create $q$ new individuals applying operators to each one in subpopulation}
...
Furthermore, we have analyzed further the obtained results has been
...
% How does this compare to the experiments performed above? Is it what
% should be expected? - JJ
...
% magnitude bigger than value? 0.002 +- 8? Really? - JJ
\end{center}
\end{table}
